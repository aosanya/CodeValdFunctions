...
> CodeValdFunctions is a standalone gRPC microservice — not a Go library import.
...
CodeValdFunctions runs as an independent process — independently scalable, isolated
