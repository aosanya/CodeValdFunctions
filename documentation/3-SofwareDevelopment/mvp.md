...
| DOC (Functions) | Function-job failure events, FJ-1..FJ-7 modes, `compile-solving-problem` & `merge-solving-problem` sketches, replaces `inject-compile-fix-todo` design | ✅ Done | — |
