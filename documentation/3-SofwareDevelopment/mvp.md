...
| FEAT-20260602-004-FUNCTIONS | CodeValdFunctions leg of WorkflowRun rollback — `FunctionsService.RollbackByWorkflowRun` cancels in-flight Jobs and freezes terminal Jobs as `rolled_back` audit; mirrors AI leg | 🚀 In Progress | ~~FEAT-20260602-002~~ ✅ |
