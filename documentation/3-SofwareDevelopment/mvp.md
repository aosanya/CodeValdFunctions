...
| FEAT-20260602-002 | `workflow_run_id` on `Job` + every `functions.job.*` event payload (Functions sibling of the [Cross umbrella](../../../CodeValdCross/documentation/3-SofwareDevelopment/mvp-details/FEAT-20260602-001_workflow_run_id_propagation_umbrella.md)) | 🚀 In Progress | ~~FEAT-20260602-001~~ ✅ (start-pipeline) |
